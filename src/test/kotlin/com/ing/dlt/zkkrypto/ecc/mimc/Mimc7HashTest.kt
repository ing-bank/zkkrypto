...
class Mimc7HashTest {
    ...
    fun testBigIntegerHashing() {
        ...
        val big_arr1 = listOf(b12)
        val h1 = mimc7.hash(big_arr1)
        assertEquals(
            Hex.toHexString(h1),
        "237c92644dbddb86d8a259e0e923aaab65a93f1ec5758b8799988894ac0958fd"
        )

        val big_arr2 = listOf(b78, b41)
        val h2 = mimc7.hash(big_arr2)
        assertEquals(
            Hex.toHexString(h2),
        "067f3202335ea256ae6e6aadcd2d5f7f4b06a00b2d1e0de903980d5ab552dc70"
        )

        val big_arr3 = listOf(b12, b45)
        val h3 = mimc7.hash(big_arr3)
        assertEquals(
            Hex.toHexString(h3),
        "15ff7fe9793346a17c3150804bcb36d161c8662b110c50f55ccb7113948d8879"
        )

        val big_arr4 = listOf(b12, b45, b78, b41)
        val h4 = mimc7.hash(big_arr4)
        assertEquals(
            Hex.toHexString(h4),
